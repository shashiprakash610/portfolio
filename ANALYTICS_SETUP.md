...
4. Create an account name (e.g., "Shashi Portfolio")
5. Choose "Web" as the platform
6. Enter your website details:
   - Website name: "Shashi Prakash Portfolio"
   - Website URL: `https://yourusername.github.io/portfolia`
...
<script>
  ...
  gtag('config', 'G-ABC123DEF4', {
    page_title: 'Shashi Prakash Portfolio',
